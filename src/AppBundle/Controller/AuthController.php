...
class AuthController extends Controller
{
     ...
     *
     * @Route("/auth/projects", name="projects_auth_index")
     * @Method("GET")
     */
    public function indexAuthAction()
    {
        ...
        return $this->render('project/projects_index.html.twig', array(
            'projects' => $projects,
        ));
    }
    ...
    public function newAction(Request $request)
    {
        ...
        return $this->render('auth/project_new.html.twig', array(
            'project' => $project,
    ...
    public function showAuthAction(Project $project)
    {
        ...
        return $this->render('auth/project_show.html.twig', array(
            'project' => $project,
    ...
    public function editAction(Request $request, Project $project)
    {
        ...
        return $this->render('auth/project_edit.html.twig', array(
            'project' => $project,
